...
Pour IPSS, on observe pour les trois techniques une décroissance de la valeur médiane dès le troisième mois. Dans le cadre de VAPOR et VPPBS, certains « outliers » sont présents (et ce sur l’ensemble des itérations dans le cadre de VPPBS ces « outliers » ont encore des valeurs très fortes même à partir du 18\up{ième} mois.  RTUPB  semble avoir une variance homogène à partir du 9\up{ième} mois. Si VAPOR laisse apparaître des « outliers », la valeur médiane termine plus bas que les deux autres techniques. 
